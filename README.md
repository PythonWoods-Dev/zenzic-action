...
<!-- Transcribed from the core README's generated capture (tests/sandboxes/readme_capture in
     PythonWoods-Dev/zenzic, regenerated by `just lab-blocks`). Nothing in this repository
     regenerates or checks this block: it was verified by hand on 2026-09-17 and is a reading
     obligation until a command-side check exists. -->
