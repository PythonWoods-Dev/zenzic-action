...
- [ ] `action.yml` — `default:` pin updated to the latest Zenzic core version (`0.27.1`)
- [ ] `package.json` version bumped to `2.11.1`
- [ ] `pyproject.toml` — synchronized with core pin (`zenzic==0.27.1`)
